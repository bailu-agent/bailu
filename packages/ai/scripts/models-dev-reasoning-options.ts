...
/**
 * Converts models.dev verified effort values into Bailu's selectable thinking levels.
 * Values without a Bailu equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
