...
export type RadiusGatewayModel = {
	...
	input: ("text" | "image")[];
	cost: Model<"bailu-messages">["cost"];
...
export function getRadiusModelsFromConfig(providerId: string, config: RadiusGatewayConfig): Model<"bailu-messages">[] {
