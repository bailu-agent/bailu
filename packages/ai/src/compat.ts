/**
 * Temporary compatibility entrypoint preserving the old global bailu-ai API
 ...
 *
 * Existing apps switch imports from "@bailu/ai" to
 * "@bailu/ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/bailu-messages.lazy.ts";
...
import { bailuMessagesApi } from "./api/bailu-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@bailu/ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@bailu/ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@bailu/ai/providers/all" or `Models.getProviders()`. */
...
const BUILTIN_APIS: [Api, ProviderStreams][] = [
	...
	["bailu-messages", bailuMessagesApi()],
];
