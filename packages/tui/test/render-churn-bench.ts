 ...
 * frames on a layout mirroring bailu's fullscreen interactive mode:
...
async function main(): Promise<void> {
	...
	const tui = new TuiAltScreen(terminal, false, "/tmp/bailu-tui-bench");
	...
	const footer = new Text("\x1b[2m~/workspaces/bailu  main  100k tokens\x1b[22m", 1, 0);
