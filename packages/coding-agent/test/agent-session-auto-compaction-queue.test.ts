...
import { type AssistantMessage, createAssistantMessageEventStream, fauxAssistantMessage } from "@bailu/ai";
...
describe("AgentSession auto-compaction queue resume", () => {
	...
	beforeEach(async () => {
		tempDir = join(tmpdir(), `bailu-auto-compaction-queue-${Date.now()}`);
