...
import type { AssistantMessage, Context, Model } from "@bailu/ai";
...
vi.mock("@bailu/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@bailu/ai/compat")>();
	return {
		...actual,
...
describe("generateSummary reasoning options", () => {
	...
	it("leaves Anthropic refusal fallback handling to bailu-ai model metadata", async () => {
		await generateSummary(
			messages,
