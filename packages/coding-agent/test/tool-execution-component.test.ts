...
import { Text, type TUI, type TuiMouseEvent } from "@bailu/tui";
...
describe("ToolExecutionComponent parity", () => {
	...
	for (const scenario of [
		...
		{
			title: "AGENTS.md",
			path: join(process.cwd(), ".bailu", "AGENTS.md"),
			content: "Hidden resource instructions",
			compact: "read resource .bailu/AGENTS.md",
			hidden: "Hidden resource instructions",
			absent: undefined,
		},
		{
			title: "AGENTS.override.md",
			path: join(process.cwd(), ".bailu", "AGENTS.override.md"),
			content: "Hidden override instructions",
			compact: "read resource .bailu/AGENTS.override.md",
	...
	for (const scenario of [
		...
		{ title: "Bailu documentation", path: getReadmePath(), compact: "read docs README.md:120-329" },
	] as const) {
