...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@bailu/tui";
...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			{
				path: "/tmp/project/.bailu/extensions/answer.ts",
				sourceInfo: createSourceInfo("/tmp/project/.bailu/extensions/answer.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.bailu/extensions",
				}),
			},
			{
				path: "/tmp/project/.bailu/extensions/local-index/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.bailu/extensions/local-index/index.ts", {
					source: "local",
					scope: "project",
					origin: "top-level",
					baseDir: "/tmp/project/.bailu/extensions",
			...
			{
				path: "/tmp/project/.bailu/npm/node_modules/bailu-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.bailu/npm/node_modules/bailu-markdown-preview/extensions/index.ts",
					{
						source: "npm:bailu-markdown-preview",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.bailu/npm/node_modules/bailu-markdown-preview",
					},
				),
			},
			{
				path: "/tmp/project/.bailu/npm/node_modules/@scope/bailu-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.bailu/npm/node_modules/@scope/bailu-scoped/extensions/index.ts",
					{
						source: "npm:@scope/bailu-scoped",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.bailu/npm/node_modules/@scope/bailu-scoped",
					},
				),
			},
			{
				path: "/tmp/project/.bailu/git/github.com/HazAT/bailu-interactive-subagents/extensions/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.bailu/git/github.com/HazAT/bailu-interactive-subagents/extensions/index.ts",
					{
						source: "git:github.com/HazAT/bailu-interactive-subagents",
						scope: "project",
						origin: "package",
						baseDir: "/tmp/project/.bailu/git/github.com/HazAT/bailu-interactive-subagents",
					},
				),
			},
			{
				path: "/tmp/project/.bailu/git/github.com/HazAT/bailu-interactive-subagents/extensions/subagents/index.ts",
				sourceInfo: createSourceInfo(
					"/tmp/project/.bailu/git/github.com/HazAT/bailu-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/bailu-interactive-subagents",
						scope: "project",
						origin: "package",
...
"[Extensions]
  @scope/bailu-scoped, answer.ts, bailu-markdown-preview, cli-extension.ts, HazAT/bailu-interactive-subagents, HazAT/bailu-interactive-subagents:subagents, local-index, user-index"`);
	});
...
"[Extensions]
  main.ts"`);
	...
	test("package extensions still strip index.ts correctly (regression guard)", () => {
		...
		expect(normalizeRenderedOutput(fakeThis.loadedResourcesContainer)).toMatchInlineSnapshot(`
"[Extensions]
  bailu-markdown-preview"`);
	});

	test("labels npm sibling extensions relative to the declaring package", () => {
		const extensions: ExtensionFixture[] = [
			{
				path: "/tmp/project/.bailu/npm/node_modules/primary-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.bailu/npm/node_modules/primary-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.bailu/npm/node_modules/primary-package",
				}),
			},
			{
				path: "/tmp/project/.bailu/npm/node_modules/sibling-package/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.bailu/npm/node_modules/sibling-package/index.ts", {
					source: "npm:primary-package",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.bailu/npm/node_modules/primary-package",
...
"[Extensions]
  primary-package, primary-package:../sibling-package"`);
	...
	test("labels Windows npm sibling extensions relative to the declaring package", () => {
		const primaryPath = "C:\\Users\\me\\.bailu\\agent\\npm\\node_modules\\primary-package\\index.ts";
		const siblingPath = "C:\\Users\\me\\.bailu\\agent\\npm\\node_modules\\sibling-package\\index.ts";
		const baseDir = "C:\\Users\\me\\.bailu\\agent\\npm\\node_modules\\primary-package";
		const extensions: ExtensionFixture[] = [
			{
				path: primaryPath,
...
"[Extensions]
  project
    /tmp/project/.bailu/extensions/answer.ts
    /tmp/project/.bailu/extensions/local-index
    git:github.com/HazAT/bailu-interactive-subagents
      extensions
      extensions/subagents
    npm:@scope/bailu-scoped
      extensions
    npm:bailu-markdown-preview
      extensions
  user
  ...
  path
	...
	test("shows context paths relative to cwd while preserving full external paths", () => {
		...
		const fakeThis = createShowLoadedResourcesThis({
			...
			cwd,
			contextFiles: [
				{ path: path.join(home, ".bailu", "agent", "AGENTS.md") },
		...
		expect(output).toContain("~/.bailu/agent/AGENTS.md, AGENTS.md");
	...
	test("shows system prompt context paths before project context files", () => {
		...
		const fakeThis = createShowLoadedResourcesThis({
			quietStartup: false,
			cwd,
			systemPromptSource: { path: path.join(cwd, ".bailu", "SYSTEM.md") },
			appendSystemPromptSources: [{ path: path.join(cwd, ".bailu", "APPEND_SYSTEM.md") }],
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain(".bailu/SYSTEM.md, .bailu/APPEND_SYSTEM.md, AGENTS.md");
	});
	...
	test("shows full context paths when expanded", () => {
		...
		const output = renderAll(fakeThis.loadedResourcesContainer).replace(/\\/g, "/");
		expect(output).toContain("[Context]");
		expect(output).toContain("~/.bailu/agent/AGENTS.md");
		expect(output).toContain("~/Development/pi-mono/AGENTS.md");
		expect(output).not.toContain("~/.bailu/agent/AGENTS.md, AGENTS.md");
	});
