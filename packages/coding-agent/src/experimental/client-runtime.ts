...
import { Client, ServerError } from "@bailu/client";
import { createUnixTransportFactory, discoverUnixServers, type UnixServerRoute } from "@bailu/client/unix";
...
export interface OpenClientRuntimeOptions {
	/** Directory searched when --connect is omitted. Defaults to BAILU_SERVER_DIR or ~/.bailu/server. */
