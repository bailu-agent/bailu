import { combineFacetLoaders, type FacetLoader, type JsonValue } from "@bailu/chord";
import {
...
const BAILU_PLUGIN_API = "@bailu/coding-agent/experimental/plugin";
...
function resolvePluginExternal(specifier: string): string | undefined {
	if (specifier !== BAILU_PLUGIN_API) return undefined;
