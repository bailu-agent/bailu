...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@bailu/coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@bailu/coding-agent";
	 *
...
export interface ExtensionContext {
	...
	/** Gracefully shutdown bailu and exit. Available in all contexts. */
	shutdown(): void;
...
export interface BeforeAgentStartEvent {
	...
	systemPrompt: string;
	/** Structured options used to build the system prompt. Extensions can inspect this to understand what Bailu loaded without re-discovering resources. */
...
/** Fired when Bailu starts waiting on a blocking user-facing extension UI prompt. */
...
/** Fired when Bailu is no longer waiting on a blocking user-facing extension UI prompt. */
...
export interface ExtensionAPI {
	...
	/** Register a transformer for user and assistant Markdown before Bailu renders it in the interactive transcript. */
...
/** Configuration for registering a provider via bailu.registerProvider(). */
...
export type ExtensionFactory = (bailu: ExtensionAPI) => void | Promise<void>;
...
export interface ExtensionRuntimeState {
	...
	/** Native bailu-ai provider registrations queued during extension loading, processed when runner binds. */
