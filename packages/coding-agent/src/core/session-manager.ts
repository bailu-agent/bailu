...
import { type ImageContent, type Message, type TextContent, type Usage, uuidv7 } from "@bailu/ai";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an extension, undefined/false if bailu-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	usage?: Usage;
	/** True if generated by an extension, false if bailu-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.bailu/agent/sessions/.
 */
...
export class SessionManager {
	...
	private _setSessionFile(sessionFile: string, preloadedFileEntries?: FileEntry[]): void {
		...
		if (existsSync(this.sessionFile)) {
			...
			// non-empty but did not parse as a bailu session, fail without modifying it.
			if (entries.length === 0) {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.bailu/agent/sessions/<encoded-cwd>/).
	 */
