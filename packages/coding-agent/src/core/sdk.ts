...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@bailu/agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@bailu/ai/compat";
...
// provider-agnostic and does not import bailu-ai/compat itself.
setDefaultStreamFn(streamSimple);

export interface CreateAgentSessionOptions {
	/** Working directory for project-local discovery. Default: process.cwd() */
	cwd?: string;
	/** Global config directory. Default: ~/.bailu/agent */
	agentDir?: string;
	 ...
	 *
	 * When omitted, bailu uses the `defaultTools` setting for the initial built-in
