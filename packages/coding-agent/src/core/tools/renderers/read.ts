...
import type { ImageContent, TextContent } from "@bailu/ai";
...
function getBailuDocsClassification(absolutePath: string): CompactReadClassification | undefined {
...
function getCompactReadClassification(
	...
	const docsClassification = getBailuDocsClassification(absolutePath);
