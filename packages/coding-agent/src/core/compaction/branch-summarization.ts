...
import type { AgentMessage, StreamFn } from "@bailu/agent-core";
import type { RetryCallbacks, RetryPolicy } from "@bailu/ai";
import { contentText } from "@bailu/ai";
import type { Model, SimpleStreamOptions, Usage } from "@bailu/ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from bailu-generated summaries (fromHook !== true), not extension-generated ones
