...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@bailu/agent-core";
import { contentText, type RetryCallbacks, type RetryPolicy, retryAssistantCall, uuidv7 } from "@bailu/ai";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@bailu/ai/compat";
import { completeSimple } from "@bailu/ai/compat";
...
function extractFileOperations(
	...
	// Collect from previous compaction's details (if bailu-generated)
