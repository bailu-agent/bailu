...
import { contentText, retryDelayMs } from "@bailu/ai";
import type {
	AssistantMessage,
	AuthResult,
	ImageContent,
...
export class AgentSession {
	 ...
	 * - Handles extension commands (registered via bailu.registerCommand) immediately, even during streaming
	...
	async prompt(text: string, options?: PromptOptions): Promise<void> {
		...
		try {
			...
			// Extension commands manage their own LLM interaction via bailu.sendMessage()
	...
	/** Generate Bailu's built-in compaction summary for manual and automatic compaction. */
