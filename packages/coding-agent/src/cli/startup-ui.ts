import { ProcessTerminal, setCapabilityOverrides, setKeybindings, type TUI, TuiMainScreen } from "@bailu/tui";
...
const OFFICIAL_PACKAGE_NAME = "@bailu/coding-agent";
const OFFICIAL_APP_NAME = "bailu";
const OFFICIAL_CONFIG_DIR_NAME = ".bailu";
 ...
 * - this is the official Bailu distribution (not a fork/rebrand)
 * - experimental features are enabled (BAILU_EXPERIMENTAL=1)
