...
declare const BAILU_BUNDLED_NODE: boolean;
export const isBundledNode = typeof BAILU_BUNDLED_NODE !== "undefined" && BAILU_BUNDLED_NODE;
...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/bailu-agent/bailu/releases/latest`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.BAILU_PACKAGE_DIR;
	if (envDir) {
...
const bailuConfigName: string | undefined = pkg.piConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@bailu/coding-agent";
export const APP_NAME: string = bailuConfigName || "bailu";
export const APP_TITLE: string = bailuConfigName ? APP_NAME : "Bailu";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".bailu";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., BAILU_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
...
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.BAILU_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.bailu/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.bailu/agent/) */
