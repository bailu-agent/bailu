...
const MIGRATION_GUIDE_URL =
	"https://github.com/bailu-agent/bailu/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL = "https://github.com/bailu-agent/bailu/blob/main/packages/coding-agent/docs/extensions.md";
...
/**
 * Migrate sessions from ~/.bailu/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.bailu/agent/ instead of
 * ~/.bailu/agent/sessions/<encoded-cwd>/. This migration moves them
 ...
 * Note: tools/ may contain fd/rg binaries extracted by bailu, so only warn if it has other files.
 */
