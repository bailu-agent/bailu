...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "@bailu/coding-agent";
...
export default function (bailu: ExtensionAPI) {
	...
	bailu.on("agent_end", async (event) => {
	...
	// Register a command
	bailu.registerCommand("mycommand", {
