import { defineFacet } from "@bailu/chord";
import { AgentController, PresentationUI, SlashCommands } from "@bailu/coding-agent/experimental/plugin";
import { ExampleFacetService } from "./contract.ts";

export default defineFacet({
	id: "@bailu/example-plugin/tui",
	setup(env) {
