 ...
 *
 * Usage: bailu --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@bailu/tui";

export default function (bailu: ExtensionAPI) {
	bailu.registerCommand("overlay-test", {
