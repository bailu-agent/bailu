 ...
 *
 * Usage: bailu --extension ./examples/extensions/overlay-qa-tests.ts
 *
 * Commands:
...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@bailu/coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@bailu/tui";
import { Input, matchesKey, truncateToWidth, visibleWidth } from "@bailu/tui";
...
export default function (bailu: ExtensionAPI) {
	// Animation demo - proves overlays can handle real-time updates (like bailu-doom would need)
	bailu.registerCommand("overlay-animation", {
	...
	bailu.registerCommand("overlay-anchors", {
	...
	bailu.registerCommand("overlay-margins", {
	...
	bailu.registerCommand("overlay-stack", {
	...
	bailu.registerCommand("overlay-overflow", {
	...
	bailu.registerCommand("overlay-edge", {
	...
	bailu.registerCommand("overlay-percent", {
	...
	// Test maxHeight
	bailu.registerCommand("overlay-maxheight", {
	...
	bailu.registerCommand("overlay-sidepanel", {
	...
	bailu.registerCommand("overlay-toggle", {
	...
	bailu.registerCommand("overlay-passive", {
	...
	bailu.registerCommand("overlay-focus", {
	...
	bailu.registerCommand("overlay-streaming", {
...
// Animation demo - proves overlays can handle real-time updates like bailu-doom
class AnimationDemoComponent extends BaseOverlay {
	...
	render(width: number): string[] {
		...
		lines.push(border("│") + padLine(th.fg("dim", " (bailu-doom uses same approach)")) + border("│"));
		lines.push(border("│") + padLine(``) + border("│"));
