...
Example extensions for bailu-coding-agent.

## Usage

```bash
# Load an extension with --extension flag
bailu --extension examples/extensions/permission-gate.ts

# Or copy to extensions directory for auto-discovery
cp permission-gate.ts ~/.bailu/agent/extensions/
```
...
| Extension | Description |
|-----------|-------------|
| `mac-system-theme.ts` | Syncs bailu theme with macOS dark/light mode |
...
| `custom-provider-gitlab-duo/` | GitLab Duo provider using bailu-ai's built-in Anthropic/OpenAI streaming via proxy |
