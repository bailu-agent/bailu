 ...
 * Delegates to bailu-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   bailu -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (bailu: ExtensionAPI) {
	bailu.registerProvider("gitlab-duo", {
