...
Play DOOM as an overlay in bailu. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
bailu --extension ./examples/extensions/doom-overlay
```
...
- [bailu-doom](https://github.com/badlogic/pi-doom) for the original bailu integration
