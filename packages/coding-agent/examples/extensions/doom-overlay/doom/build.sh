#!/usr/bin/env bash
# Build DOOM for bailu-doom using doomgeneric and Emscripten
...
cp "$DOOM_DIR/doomgeneric_bailu.c" "$DOOM_DIR/doomgeneric/doomgeneric/"
