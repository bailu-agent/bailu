import { uuidv7 } from "@bailu/ai";
import type { ExtensionAPI, ExtensionCommandContext } from "@bailu/coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@bailu/coding-agent";
import { Container, Markdown, matchesKey, Text } from "@bailu/tui";
...
export default function (bailu: ExtensionAPI) {
	bailu.registerCommand("summarize", {
