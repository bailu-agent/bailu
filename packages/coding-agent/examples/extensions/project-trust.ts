 ...
 *
 *   mkdir -p ~/.bailu/agent/extensions
 *   cp packages/coding-agent/examples/extensions/project-trust.ts ~/.bailu/agent/extensions/
 *
 * Or:
 *
 *   bailu -e packages/coding-agent/examples/extensions/project-trust.ts
 *
 * Try it in a project containing .bailu, AGENTS.md/CLAUDE.md, or .agents/skills.
 */

import type { ExtensionAPI, ProjectTrustEventResult } from "@bailu/coding-agent";
...
export default function (bailu: ExtensionAPI) {
	...
	bailu.on("project_trust", async (event, ctx): Promise<ProjectTrustEventResult> => {
