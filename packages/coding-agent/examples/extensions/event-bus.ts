 ...
 *
 * Shows bailu.events for communication between extensions. One extension
...
export default function (bailu: ExtensionAPI) {
	...
	bailu.events.on("my:notification", (data) => {
