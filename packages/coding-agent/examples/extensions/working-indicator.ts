 ...
 * working indicator shown while bailu is streaming a response.
 *
 * Usage:
 *   bailu --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore bailu's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@bailu/coding-agent";
...
export default function (bailu: ExtensionAPI) {
	...
	bailu.registerCommand("working-indicator", {
