 ...
 * Commands Extension
 *
 * Demonstrates the bailu.getCommands() API by providing a /commands command
...
import type { ExtensionAPI, SlashCommandInfo } from "@bailu/coding-agent";

export default function commandsExtension(bailu: ExtensionAPI) {
	bailu.registerCommand("commands", {
