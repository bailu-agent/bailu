 ...
 * - Routing tool calls to remote systems (e.g., bailu-ssh-remote)
...
import type { TextContent } from "@bailu/ai";
import { type ExtensionAPI, getAgentDir, withFileMutationQueue } from "@bailu/coding-agent";
...
export default function (bailu: ExtensionAPI) {
	...
	bailu.registerCommand("read-log", {
