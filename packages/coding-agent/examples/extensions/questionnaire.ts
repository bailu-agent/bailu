...
import { Editor, type EditorTheme, Key, matchesKey, Text, visibleWidth, wrapTextWithAnsi } from "@bailu/tui";
...
export default function questionnaire(bailu: ExtensionAPI) {
	bailu.registerTool({
		name: "questionnaire",
		label: "Questionnaire",
		description:
