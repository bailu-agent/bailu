> bailu can create prompt templates. Ask it to build one for your workflow.
...
Bailu loads prompt templates from:

- Global: `~/.bailu/agent/prompts/*.md`
- Project: `.bailu/prompts/*.md` (only after the project is trusted)
