...
export default defineConfig({
	...
	resolve: {
		conditions: ["source"],
		alias: [
			{ find: /^@bailu\/telemetry$/, replacement: telemetryIndex },
			{ find: /^@bailu\/agent-core\/node$/, replacement: agentNode },
			{ find: /^@bailu\/agent-core\/harness\/session\/testing$/, replacement: agentSessionTesting },
			{ find: /^@bailu\/agent-core$/, replacement: agentIndex },
			{ find: /^@bailu\/ai$/, replacement: aiIndex },
		],
	},
