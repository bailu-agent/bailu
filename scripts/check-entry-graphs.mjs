...
const WORKSPACE = {
	"@bailu/chord": "packages/chord/src",
	"@bailu/ai": "packages/ai/src",
	"@bailu/agent-core": "packages/agent/src",
	"@bailu/telemetry": "packages/telemetry/src",
	"@bailu/tui": "packages/tui/src",
};
