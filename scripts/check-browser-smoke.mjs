...
const outputPath = join(tmpdir(), "bailu-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "bailu-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "bailu-browser-smoke-errors.log");
