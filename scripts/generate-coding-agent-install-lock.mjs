...
const internalPackagePrefix = "@bailu/";
const internalPackageNames = new Set(["@bailu/chord"]);
const installPackageName = "@bailu/coding-agent-install";
...
function createInstallerPackageJson(codingAgentPackage) {
	const packageJson = {
		...
		private: true,
		description: "Lockfile root used by the Bailu installer and updater.",
		dependencies: {
